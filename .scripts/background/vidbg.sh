...
#vo='vdpau'
vo='gpu'
xwinwrap -g ${SCREEN_X}x${SCREEN_Y} -ov -ni -s -nf -- mpv --vo=$vo --no-audio --loop --wid WID ~/cloud/wall/vid/$s1 &
xwinwrap -g ${SCREEN_X}x${SCREEN_Y}+${SCREEN_X}+0 -ov -ni -s -nf -- mpv --vo=$vo --no-audio --loop --wid WID ~/cloud/wall/vid/$s2 &
